...
<sql:setDataSource var="jdbc" driver="org.postgresql.Driver"
	url="jdbc:postgresql://localhost/estc" user="estc" password="Shakeo" />

<graph:graph>
	<sql:query var="authors" dataSource="${jdbc}">
	...
	<sql:query var="printers" dataSource="${jdbc}">
	...
	<sql:query var="publishers" dataSource="${jdbc}">
	...
	<sql:query var="sellers" dataSource="${jdbc}">
	...
	<sql:query var="authorPrinter" dataSource="${jdbc}">
	...
	<sql:query var="authorPublisher" dataSource="${jdbc}">
	...
	<sql:query var="authorSeller" dataSource="${jdbc}">
	...
	<sql:query var="printerPublisher" dataSource="${jdbc}">
	...
	<sql:query var="printerSeller" dataSource="${jdbc}">
	...
	<sql:query var="publisherSeller" dataSource="${jdbc}">
